...
| 版本 | 检查 | 级别 | 结果 | 说明 |
|---|---|---|---|---|
| global | deterministic_regeneration | error | 通过 | 104 generated files compared byte-for-byte |
| v0.2-seed | schema_version | error | 通过 | expected 1.2.0, actual 1.2.0 |
...
| v0.2-seed | dimensions_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | roles_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | role_skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | users_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.2-seed | user_skill_evidence_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.2-seed | user_skill_scores_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.2-seed | jobs_date_values | error | 通过 | 4 temporal fields valid |
...
| v0.2-seed | job_skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | learning_resources_date_values | error | 通过 | 2 temporal fields valid |
| v0.2-seed | resource_skills_manifest_count | error | 通过 | manifest=130, csv=130 |
| v0.2-seed | resource_skills_unique | error | 通过 | resource_skill_id: 130/130 unique |
| v0.2-seed | resource_skills_common_headers | error | 通过 | all common metadata fields present |
| v0.2-seed | resource_skills_metadata_values | error | 通过 | 130 metadata rows valid |
| v0.2-seed | resource_skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | growth_events_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.2-seed | trend_snapshots_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.2-seed | scenario_cases_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | golden_profile_snapshots_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.2-seed | career_paths_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | career_milestones_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | golden_expected_results_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | knowledge_cards_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | retrieval_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | matching_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | path_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | dialogue_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | fairness_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | privacy_security_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.2-seed | source_registry_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.2-seed | knowledge_cards_expected_count | error | 通过 | expected=200, actual=200 |
| v0.2-seed | retrieval_eval_expected_count | error | 通过 | expected=50, actual=50 |
| v0.2-seed | users_stage_enum | error | 通过 | 2 allowed values used |
| v0.2-seed | jobs_work_mode_enum | error | 通过 | 3 allowed values used |
| v0.2-seed | learning_resources_resource_type_enum | error | 通过 | 5 allowed values used |
| v0.2-seed | learning_resources_difficulty_enum | error | 通过 | 3 allowed values used |
| v0.2-seed | scenario_cases_difficulty_enum | error | 通过 | 3 allowed values used |
| v0.2-seed | privacy_security_eval_severity_enum | error | 通过 | 2 allowed values used |
| v0.2-seed | knowledge_cards_category_enum | error | 通过 | 6 allowed values used |
...
| v0.2-seed | knowledge_category_mix | error | 通过 | {"skill_level":90,"learning_resource":60,"role_skill":9,"role_adjacent_skill":21,"trend_interpretation":10,"ethics_privacy":10} |
...
| v0.2-seed | resource_skills_resource_fk | error | 通过 | 130 references valid |
| v0.2-seed | resource_skills_skill_fk | error | 通过 | 130 references valid |
...
| v0.2-seed | retrieval_expected_card_fk | error | 通过 | 50 retrieval cases reference current package cards |
| v0.2-seed | knowledge_entity_fk | error | 通过 | 200 knowledge-card entities resolve |
| v0.2-seed | knowledge_direct_role_relations | error | 通过 | 9 direct role cards map to role_skills |
| v0.2-seed | knowledge_adjacent_role_relations | error | 通过 | 21 adjacent role cards are outside role_skills |
| v0.2-seed | knowledge_adjacent_metadata | error | 通过 | 21 adjacent cards are synthetic and excluded from scoring |
| v0.2-seed | knowledge_role_balance | error | 通过 | direct={"ROLE-DATA":3,"ROLE-AI-ALG":3,"ROLE-AI-APP":3}, adjacent={"ROLE-AI-ALG":7,"ROLE-AI-APP":7,"ROLE-DATA":7} |
...
| v0.2-seed | retrieval_expected_source_fk | error | 通过 | all retrieval expected_source_ids resolve |
| v0.5-core | schema_version | error | 通过 | expected 1.2.0, actual 1.2.0 |
...
| v0.5-core | dimensions_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | roles_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | role_skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | users_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.5-core | user_skill_evidence_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.5-core | user_skill_scores_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.5-core | jobs_date_values | error | 通过 | 4 temporal fields valid |
...
| v0.5-core | job_skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | learning_resources_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | resource_skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | growth_events_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.5-core | trend_snapshots_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.5-core | scenario_cases_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | golden_profile_snapshots_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.5-core | career_paths_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | career_milestones_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | golden_expected_results_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | knowledge_cards_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | retrieval_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | matching_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | path_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | dialogue_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | fairness_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | privacy_security_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v0.5-core | source_registry_date_values | error | 通过 | 3 temporal fields valid |
...
| v0.5-core | knowledge_cards_expected_count | error | 通过 | expected=600, actual=600 |
| v0.5-core | retrieval_eval_expected_count | error | 通过 | expected=100, actual=100 |
| v0.5-core | users_stage_enum | error | 通过 | 2 allowed values used |
| v0.5-core | jobs_work_mode_enum | error | 通过 | 3 allowed values used |
| v0.5-core | learning_resources_resource_type_enum | error | 通过 | 5 allowed values used |
| v0.5-core | learning_resources_difficulty_enum | error | 通过 | 3 allowed values used |
| v0.5-core | scenario_cases_difficulty_enum | error | 通过 | 3 allowed values used |
| v0.5-core | privacy_security_eval_severity_enum | error | 通过 | 2 allowed values used |
| v0.5-core | knowledge_cards_category_enum | error | 通过 | 6 allowed values used |
...
| v0.5-core | knowledge_category_mix | error | 通过 | {"skill_level":250,"learning_resource":200,"role_skill":27,"role_adjacent_skill":63,"trend_interpretation":30,"ethics_privacy":30} |
...
| v0.5-core | retrieval_expected_card_fk | error | 通过 | 100 retrieval cases reference current package cards |
| v0.5-core | knowledge_entity_fk | error | 通过 | 600 knowledge-card entities resolve |
| v0.5-core | knowledge_direct_role_relations | error | 通过 | 27 direct role cards map to role_skills |
| v0.5-core | knowledge_adjacent_role_relations | error | 通过 | 63 adjacent role cards are outside role_skills |
| v0.5-core | knowledge_adjacent_metadata | error | 通过 | 63 adjacent cards are synthetic and excluded from scoring |
| v0.5-core | knowledge_role_balance | error | 通过 | direct={"ROLE-AI-ALG":9,"ROLE-AI-APP":9,"ROLE-DATA":9}, adjacent={"ROLE-AI-ALG":21,"ROLE-AI-APP":21,"ROLE-DATA":21} |
...
| v0.5-core | retrieval_expected_source_fk | error | 通过 | all retrieval expected_source_ids resolve |
| v1.0-full | schema_version | error | 通过 | expected 1.2.0, actual 1.2.0 |
...
| v1.0-full | dimensions_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | roles_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | role_skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | users_date_values | error | 通过 | 3 temporal fields valid |
...
| v1.0-full | user_skill_evidence_date_values | error | 通过 | 3 temporal fields valid |
...
| v1.0-full | user_skill_scores_date_values | error | 通过 | 3 temporal fields valid |
...
| v1.0-full | jobs_date_values | error | 通过 | 4 temporal fields valid |
...
| v1.0-full | job_skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | learning_resources_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | resource_skills_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | growth_events_date_values | error | 通过 | 3 temporal fields valid |
...
| v1.0-full | trend_snapshots_date_values | error | 通过 | 3 temporal fields valid |
...
| v1.0-full | scenario_cases_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | golden_profile_snapshots_date_values | error | 通过 | 3 temporal fields valid |
...
| v1.0-full | career_paths_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | career_milestones_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | golden_expected_results_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | knowledge_cards_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | retrieval_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | matching_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | path_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | dialogue_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | fairness_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | privacy_security_eval_date_values | error | 通过 | 2 temporal fields valid |
...
| v1.0-full | source_registry_date_values | error | 通过 | 3 temporal fields valid |
...
| v1.0-full | knowledge_cards_expected_count | error | 通过 | expected=1200, actual=1200 |
| v1.0-full | retrieval_eval_expected_count | error | 通过 | expected=200, actual=200 |
| v1.0-full | users_stage_enum | error | 通过 | 2 allowed values used |
| v1.0-full | jobs_work_mode_enum | error | 通过 | 3 allowed values used |
| v1.0-full | learning_resources_resource_type_enum | error | 通过 | 5 allowed values used |
| v1.0-full | learning_resources_difficulty_enum | error | 通过 | 3 allowed values used |
| v1.0-full | scenario_cases_difficulty_enum | error | 通过 | 3 allowed values used |
| v1.0-full | privacy_security_eval_severity_enum | error | 通过 | 2 allowed values used |
| v1.0-full | knowledge_cards_category_enum | error | 通过 | 6 allowed values used |
...
| v1.0-full | knowledge_category_mix | error | 通过 | {"skill_level":300,"learning_resource":600,"role_skill":54,"role_adjacent_skill":126,"trend_interpretation":60,"ethics_privacy":60} |
...
| v1.0-full | retrieval_expected_card_fk | error | 通过 | 200 retrieval cases reference current package cards |
| v1.0-full | knowledge_entity_fk | error | 通过 | 1200 knowledge-card entities resolve |
| v1.0-full | knowledge_direct_role_relations | error | 通过 | 54 direct role cards map to role_skills |
| v1.0-full | knowledge_adjacent_role_relations | error | 通过 | 126 adjacent role cards are outside role_skills |
| v1.0-full | knowledge_adjacent_metadata | error | 通过 | 126 adjacent cards are synthetic and excluded from scoring |
| v1.0-full | knowledge_role_balance | error | 通过 | direct={"ROLE-AI-ALG":18,"ROLE-AI-APP":18,"ROLE-DATA":18}, adjacent={"ROLE-AI-ALG":42,"ROLE-AI-APP":42,"ROLE-DATA":42} |
...
| v1.0-full | retrieval_expected_source_fk | error | 通过 | all retrieval expected_source_ids resolve |
